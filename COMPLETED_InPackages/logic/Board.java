...
public class Board {
	...
	public int ROWS;
	public int COLUMNS;
    private AltMazeGenerator altMaze;
    ...
    private int genStartColumn = 0;
	private int genStartRow = 0;
	private int genCurrentColumn = 100000; // set to something start row will never be
	private int genCurrentRow = 100000; // set to something start row will never be
	private int lastMove = 5;
	private int backtrackMove = 5;
	private int randomPick;
	private int randomMove = 99; // 0 = N, 1 = E, 2 = S, 3 = W
	private int repetitions = 0;
	private int stuckInLoop = 0;
	private boolean didBacktrack = false;
    ...
    altMaze = new AltMazeGenerator(ROWS, COLUMNS);
	}
  ...
  public void genNodeBoard() {
    altMaze.generateBoard();
    board = altMaze.board;
  }
